...
if __name__ == "__main__":
    ...
    # В данном примере мы создаем классы подсистем Subsystem1 и Subsystem2, 
    # а затем создаем класс фасада Facade, который использует методы подсистем для выполнения операции. 
    # Клиентский код вызывает методы фасада. Фасад скрывает сложность подсистемы от клиента.